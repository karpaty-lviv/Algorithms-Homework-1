...
class Task2_V2_3 : public StudentDatabase
{
public:
    virtual ~Task2_V2_3() = default;
...
private:
    ...
    using BirthdayCounts = std::map<std::pair<int, int>, int>;

    std::unordered_map<std::string, BirthdayCounts> m_group_stats;
};